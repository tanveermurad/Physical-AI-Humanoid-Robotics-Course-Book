You are my book-writing assistant.

I am uploading a manuscript. I want you to:

1. Extract **all chapters** clearly.
...
3. Clean formatting (remove double spaces, improper breaks).
4. Improve grammar but DO NOT change the meaning.
5. Export everything as individual Markdown files.

Output everything between ``` fences so I can paste easily into Cursor.
